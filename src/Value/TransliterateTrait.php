...
{
  /**
   * @var string[] Array with regex strings for use with preg_replace to replace accent characters.
   */
  ...
  {
    foreach ($this->transliteration as $key => $value)
    {
  ...
  protected function replaceQuotes($string)
  {
